...
import com.example.application.views.components.forms.CreateAccountForm;
import com.example.application.views.components.forms.RequestForm;
...
public class AdminView extends VerticalLayout {
    ...
    private void addContent(){
        ...
        Anchor anchor = new Anchor("https://github.com/GuillaumeChamp/FirstWebApp","GitHub");
