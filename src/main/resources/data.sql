...
INSERT INTO Country (id, phone_code, country_code, country_name) VALUES
(1, 93, 'AF', 'Afghanistan'),
...
CREATE TABLE IF NOT EXISTS ExchangeType (
  id int(2) NOT NULL,
  name_ext varchar(40) NOT NULL DEFAULT 'NA',
  name varchar(40) NOT NULL,
  PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


INSERT INTO ExchangeType (id, name_ext, name) VALUES
(1, 'ERASMUS(EU Student)', 'KA131Student'),
(2, 'ERASMUS(NON-EU Student)', 'KA171Student'),
(3, 'ERASMUS(EU trainee)', 'KA131Intern'),
(4, 'ERASMUS(NON-EU trainee)', 'KA171Intern'),
(5, 'Free Mover', 'Admis sur titre'),
(6, 'NON-EU Bilateral Exchange', 'NON-EU Bilateral Exchange'),
(7, 'EU Bilateral Exchange', 'EU Bilateral Exchange'),
(8, 'Double degree(EU,Non-Erasmus)', 'Double degree(EU,Non-Erasmus)'),
(9, 'Double degree(Non-EU)', 'Double degree(Non-EU)'),
(10, 'FAME', 'FAME'),
(11, 'GE3', 'GE3'),
(12, 'N+i', 'N+i'),
(13, 'NON ERASMUS intern', 'stagiaire non-ERASMUS'),
(14, 'other', 'autre');

CREATE TABLE IF NOT EXISTS Job (
  id int(2) NOT NULL,
  job varchar(66) NOT NULL,
  PRIMARY KEY (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(21, 'Artisan'),
(22, 'Merchant'),
(23, 'CEO of 10 or more employees'),
(31, 'Liberal profession'),
(33, 'public service executive'),
(34, 'professor, scientific profession'),
(35, 'profession of information, arts and entertainment'),
(37, 'corporate administrative and commercial framework'),
(38, 'engineer and technical manager'),
(42, 'teacher and equivalent'),
(43, 'intermediary health and social work profession'),
(44, 'clergy, religious'),
(45, 'intermediate administrative profession of the public service'),
(46, 'intermediate administrative and commercial profession of companies'),
(47, 'technician'),
(48, 'foreman, supervisor'),
(52, 'civil employee and public servant'),
(53, 'police and military'),
(54, 'corporate administrative employee'),
(55, 'commercial employee'),
(56, 'personal service personnel'),
(61, 'qualified worker'),
(66, 'unqualified worker'),
(69, 'farm hand'),
(71, 'retired former farmer'),
(72, 'retired former craftsman, merchant, business manager'),
(73, 'retired former executive and intermediate profession'),
(76, 'retired former employee and worker'),
(81, 'unemployed person who has never worked'),
(82, 'other people without professional activity'),
(99, 'not specified');
